CREATE TABLE IF NOT EXISTS `court_case` (
  ...
  `platform_name` varchar(64) DEFAULT NULL COMMENT '平台',
  `supplier_name` varchar(128) DEFAULT NULL COMMENT '供应商',
  `service_owner_name` varchar(64) DEFAULT NULL COMMENT '所属客服',
  `express_no` varchar(64) DEFAULT NULL COMMENT '快递单号',
  `product_name` varchar(128) DEFAULT NULL COMMENT '商品名称',
  `package_info` varchar(255) DEFAULT NULL COMMENT '套餐信息',
  `lease_mode` varchar(64) DEFAULT NULL COMMENT '租赁方式',
  ...
  `total_rent_amount` decimal(18,2) DEFAULT NULL COMMENT '总租金',
  `paid_deposit_amount` decimal(18,2) DEFAULT NULL COMMENT '已付押金',
  `remaining_deposit_amount` decimal(18,2) DEFAULT NULL COMMENT '剩余押金',
  `installment_amount` decimal(18,2) DEFAULT NULL COMMENT '期付金额',
  `installment_count` int DEFAULT NULL COMMENT '期付次数',
  `overdue_days` int DEFAULT NULL COMMENT '逾期天数',
  `remaining_days` int DEFAULT NULL COMMENT '剩余天数',
  `remaining_unpaid_amount` decimal(18,2) DEFAULT NULL COMMENT '剩余未还金额',
  `overdue_type` varchar(64) DEFAULT NULL COMMENT '逾期类型',
  `repayment_due_date` date DEFAULT NULL COMMENT '应还款日期',
  `domicile_address` varchar(500) DEFAULT NULL COMMENT '户籍地址',
