...
![CommonResult](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/01.png)
...
失败时的 `code` 字段，使用全局的错误码，稍后在 [「4. 错误码」](index.md) 小节来讲解。
...
![CommonResult](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/02.png)

CommonResult 的 `data` 字段是**泛型**，建议定义对应的 VO 类，而不是使用 Map 类。

② 在 RESTful API 失败时，通过抛出 Exception 异常，具体在 [「2. 异常处理」](index.md) 小节。
...
![GlobalExceptionHandler 异常处理](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/03.png)

### 2.2 Filter 的异常

在请求被 Spring MVC 处理之前，是先经过 Filter 处理的，此时发生异常时，是无法通过 `@ExceptionHandler` 注解来处理的。只能通过 `try catch` 的方式来实现，代码如下：

![Filter 异常处理](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/04.png)
...
![ServiceException 业务异常](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/05.png)
...
![ServiceException 业务异常](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/06.png)
...
![错误码](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/07.png)
...
![GlobalErrorCodeConstants 类](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/08.png)
...
![ServiceErrorCodeRange 类](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/09.png)

② 每个业务模块，定义自己的 ErrorCodeConstants 错误码枚举类。以 `yudao-module-system` 模块举例子，代码如下：

![ErrorCodeConstants 类](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/10.png)
...
![系统管理 -> 错误码管理](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/11.png)
...
![系统管理 -> 错误码管理](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/13.png)

#### 4.2.2 自动添加

通过 `yudao.error-code.constants-class-list` 配置项，设置需要自动添加的 ErrorCodeConstants 错误码枚举类。如下图所示：

![ 配置项](../../assets/doc.iocoder.cn/img/%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86/12.png)
