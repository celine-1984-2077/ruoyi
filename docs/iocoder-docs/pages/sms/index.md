...
短信采用异步发送，基于 [消息队列](../message-queue/event/index.md)，如下图所示：

![整体流程](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/01.png)
...
![表结构](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/02.png)
...
![短信渠道的列表](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/03.png)

② 点击 [新增] 按钮，选择渠道编码为【调试（钉钉）】，并填写信息如下图：

![短信渠道的新增](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/04.png)
...
不同短信平台的配置，可见 [「6. 短信平台附录」](index.md) 小节。

### 2.2 新建短信模板

① 点击 [系统管理 -> 消息中心 -> 短信管理 -> 短信模板] 菜单，查看短信模板的列表。如下图所示：

![短信模板的新增](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/05.png)

② 点击 [新增] 按钮，选择刚创建的短信渠道，并填写信息如下图：

![短信模板的新增](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/06.png)
...
![测试短信模板](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/08.png)

![测试短信模板](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/09.png)

友情提示：如果使用的短信渠道是阿里云、腾讯云等正式的短信平台，则会发送到填写的手机号中。例如说：

![接收示例](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/10.png)

③ 点击 [系统管理 -> 消息中心 -> 短信管理 -> 短信日志] 采单，可以查看到每条短信的发送状态、接收状态。如下图所示：

![短信日志](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/11.png)

常见问题：为什么日志的接受状态，一直处理“等待结果”？

因为你没配置短信回调 URL，导致短信平台无法回调我们的系统，所以一直等待结果。具体怎么配置，可见 [短信平台附录](index.md) 小节。
...
![短信发送](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/21.png)
...
![ 依赖](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/22.png)

② 新建对应的短信模板，如下图所示：

![新建短信模板](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/23.png)

③ 使用 Spring 注入 SmsSendApi Bean，调用对应的短信发送方法。如下图所示：

![调用 SmsSendApi 方法](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/24.png)
...
![ 配置项](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/32.png)
...
![ 依赖](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/34.png)

② 新建对应的短信模板，如下图所示：

![新建短信模板](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/35.png)
...
![SmsSceneEnum 枚举](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/36.png)

④ 使用 Spring 注入 SmsCodeApi Bean，调用对应的短信验证码的发送与使用方法。如下图所示：

![调用 SmsCodeApi 方法](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/33.png)
...
![SmsClient 接口](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/41.png)

每个短信平台，都对应一个 SmsClient 实现类。

![SmsClient 实现](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/42.png)
...
![SmsClientFactoryImpl 创建客户端](../../assets/doc.iocoder.cn/img/%E7%9F%AD%E4%BF%A1%E9%85%8D%E7%BD%AE/45.png)
...
可参考 <https://gitee.com/zhijiantianya/yudao-cloud/issues/IASUWI> 说明，我目前暂时没碰到过，不确定是不是这么解决是合理的~
