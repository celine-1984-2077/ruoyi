...
![数据库文件](../../assets/doc.iocoder.cn/img/Docker%E9%83%A8%E7%BD%B2/03.png)

#### 第二步，导入 SQL 脚本

创建一个名字为 `ruoyi-vue-pro` 数据库，执行数据库对应的 [`sql`](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/sql)  目录下的 SQL 文件，进行初始化。

![使用 Navicat 导入 SQL 脚本](../../assets/doc.iocoder.cn/img/Docker%E9%83%A8%E7%BD%B2/02.png)
...
④ 请求 <http://139.9.196.247:48080> 地址（“需要换成你的外网 IP”），成功访问前端项目的外网地址，，返回前端界面如下：

![前端界面](../../assets/doc.iocoder.cn/img/%E8%BF%90%E7%BB%B4%E6%89%8B%E5%86%8C/Docker%E9%83%A8%E7%BD%B2/06.png)
